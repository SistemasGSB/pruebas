...
$html2 = <<<EOF
	<table style="border: 1px solid #ffffff; text-align:center; font-size:10px">
		<tr>
			...
			<td width="100px" style="border: 1px solid #666; background-color:#BBFBC1;">$precio_c</td>
			...
			<td width="140px" style="border: 1px solid #666; background-color:#BBFBC1;"> $sim_cot_tci_usd_c </td>				
		</tr>
		<tr>
			<td width="150px" style="border: 1px solid #666; background-color:#00B050;color:#fff">MONTO FINANCIAR USD</td>
			<td width="100px" style="border: 1px solid #666; background-color:#BBFBC1;"> $sim_cot_mfd_c</td>
			<td width="50px" style="border: 1px solid #ffffff; background-color:white;color:white">BLANCO</td>		
	...
	<table style="border: 1px solid #333; text-align:center; line-height: 20px; font-size:10px">
            <tr>
              ...
              <td width="140px" style="border: 1px solid #666">Saldo Capital</td>
            </tr>
    </table>
EOF;
...
$amortizacion_c =  number_format($saldo_estable - $interes,2);
