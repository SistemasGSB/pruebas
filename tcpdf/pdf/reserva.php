...
class facturas{
	...
	$precio_contado = $obtener_proyecto["precio_lista"];
	$precio_contado_c = number_format($precio_contado,2);
	$precio_metro = number_format($obtener_proyecto["precio_metro"] , 2);
	...
	$primera_cuota = $obtener_cotizacion["cot_cis_usd"];
	...
	<table style="border: 1px solid #ffffff; text-align:center; line-height: 10px; font-size:8px">
		...
		<tr>
			...
			<td width="100px" style="border: 1px solid #000000; background-color:white;">US$</td>
