...
$l_sim_cot_tci_usd_c = NumeroALetras::convertir($sim_cot_tci_usd_c, "DOLARES");
$PreciFin = $precio - $sim_cot_tci_usd;

$l_PreciFin = NumeroALetras::convertir($PreciFin, "DOLARES");

$l_precio = NumeroALetras::convertir($precio,"DOLARES");
...
$l_saldo_estable_c = NumeroALetras::convertir($saldo_estable_c,"DOLARES");
...
<table style="border: 5px solid #ffffff; background-color:white;color:white">
	...
	<table style="border: 1px solid #ffffff; text-align:justify; line-height: 15px; font-size:11px">
		...
		<li>La suma de $PreciFin ($l_PreciFin), por concepto del saldo de la cuota inicial, la misma que será cancelada el $dia de $mes;</li><br>
