...
class facturas{
	...
	<table style="border: 1px solid #ffffff; text-align:center; line-height: 20px; font-size:10px">
		...
		<tr>
			<td width="100px" style="border: 1px solid #666; background-color:white;">Tipo de Cambio:</td>
			<td width="440px" style="border: 1px solid #666; background-color:white;">$tipo_cambio</td>
		</tr>
	</table>
