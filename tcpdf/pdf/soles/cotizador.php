...
class facturas{
	...
	$tipo_cambio = $obtener_cotizacion["tipo_cambio"];
	$precio = $obtener_proyecto["precio_lista"] * $tipo_cambio;
	$pfd = $obtener_cotizacion["cot_pfd"];
	$sep_usd = round($obtener_cotizacion["cot_sep_usd"]* $tipo_cambio,2);
	$cot_cis_usd = $obtener_cotizacion["cot_cis_usd"]* $tipo_cambio;
	$cot_mfd = $obtener_cotizacion["cot_mfd"]* $tipo_cambio;
	$cot_tci = $obtener_cotizacion["cot_tci"]* $tipo_cambio;
	$cot_tci_usd = $obtener_cotizacion["cot_tci_usd"]* $tipo_cambio;
	...
	<table style="border: 1px solid #333; text-align:center; line-height: 20px; font-size:10px">
		<tr>
			...
			<td width="280px" style="border: 1px solid #666;"><b>$fecha</b></td>
			<td width="100px" style="border: 1px solid #666;"><b>TIPO DE CAMBIO:</b></td>
			<td width="60px" style="border: 1px solid #666;"><b>$tipo_cambio</b></td>
		</tr>
	</table>
...
$html2 = <<<EOF
	...
	<table style="border: 1px solid #333; text-align:center; line-height: 20px;font-weight:700; font-size:11px">
		<tr>
			...
			<td width="135x" style="border: 1px solid #666; background-color:#fff;">S/.</td>
...
$pdf->Output('cotizador_soles.pdf', 'I');
	}
}
