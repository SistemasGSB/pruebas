...
class facturas{
	...
	<table style="line-height: 20px; font-size:10px;">
		...
		<tr><td width="100px" style="solid #666; color:#333"><b>Tipo de Cambio: </b></td>
			<td width="250px" style="solid #666; color:#333">$tipo_cambio</td>
			<td width="200px" style="solid #666; color:#333"><b>Arequipa, $fecha</b></td>
	...
	<table style="border: 1px solid #333; text-align:center; line-height: 20px; font-size:10px">
		<tr>
			...
			<td width="70px" style="border: 1px solid #666; background-color:#333; color:#fff">Precio (S/.)</td>
		</tr>
	</table>
EOF;
