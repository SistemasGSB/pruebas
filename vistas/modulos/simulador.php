...
<section class="content">
    ...
    <div class="modal-content">
      ...
      <form role="form" id="form_simulador" method="post" enctype="multipart/form-data">     
          <div class="box-body">
            ...
            $editarUsuario = new ControladorSimulador();
            $editarUsuario -> ctrMostrarSimuladorUrl();
        ...
        <?php
          ...
          $crearSimulacion = new ControladorSimulador();
          $crearSimulacion -> ctrCrearSimulacion();
