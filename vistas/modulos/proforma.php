...
<section class="content">
    ...
    <div class="modal-content">
      ...
      <form role="form" id="form_proforma" method="post" enctype="multipart/form-data">     
          <div class="box-body">
            ...
            $editarUsuario = new ControladorProforma();
            $editarUsuario -> ctrMostrarProformaUrl();
        ...
        <?php
          ...
          $crearProforma = new ControladorProforma();
          $crearProforma -> ctrCrearProforma();
